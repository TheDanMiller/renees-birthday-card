...
export const wishes = [
    ...
    },
    {
      ...
      "memory": "Nico- I like Renee’s hair! Anthony- Watching you get flipped out of a raft in Ohiopyle 🌊 Carrie- Lots of great memories!!  Today I’m thinking of the time we ran a 5 minute mile dodging 10 skunks 🦨 😂 Gabby- happy to have met you through her parents 😉 .",
      "img": images.pelusos
    },
    {
      "from": "Mom",
      "message": "Happy 40th birthday, Renee! Love you!",
      "memory": "My favorite middle child ❤️",
      "img": images.deb
    },
    {
      "from": "Kristine Miller",
      "message": "Happy 40th Renée!! We love you and hope your day is extra special",
      "memory": "My brother(your weird husband) introduced us!",
      "img": images.kristine
    },
    {
      "from": "Amelia Aldrich",
      "message": "Happy birthday Aunt Renée",
    ...
    },
    {
      ...
      "memory": "All the running memories, the adventures, the talks… you are such a blessing!! ♥️",
      "img": images.rebekah
    },
    {
      "from": "Nicole Gardner",
    ...
    {
      "from": "Heather Moore ",
      "message": "Happy Birthday to one of the most selfless 40 year olds I know (because I’m still 39 ;)",
      "memory": "The world is a better place with you in it, Renee. Your ‘kids’ (literal and non) are lucky to have you. Best Wishes for a year of health, happiness, and no Excel spreadsheets!	7th Grade Franklin ELA Dream Team",
      "img": images.heather
    },
    {
      "from": "Brandy Hall",
      "message": "You’re such a special woman, a wonderful mother, patient wife and creative teacher. I hope you have the best 40th birthday! You’re one of a kind girl! Im blessed to call you my friend and confidant. XO",
      "memory": "I met Renee as a young and inspiring teacher at Franklin Middle School.",
      "img": images.brandy
    },
    {
      "from": "Alaina",
      "message": "HAPPY BIRTHDAY! Aunt Nae love you!🥳🥳",
      "memory": "Just being with you and family is one of my favorite memories ever❤️",
      "img": images.alaina
    },
    {
      "from": "Sam Mott",
    ...
    },
    {
      ...
      "memory": "My favorite memory is when I would spend the night at aunt nae’s house and we would hang out in the morning when everyone would wake up.",
      "img": images.brynlee
    },
    {
      "from": "Emily Stunda",
      "message": "Happy Birthday Renee! Can’t believe you have hit the 40 mark!",
      "memory": "I will never forget being a tiny bit afraid of you as my freshman year RA. You lived right next door to me and I wanted to be sure I didn’t get in trouble. Little did I know the initial fear would turn into a cherished college/adult friendship. There are so many memories with you and Clarion and then memories as boy moms. I did really enjoy our road trip to put in bay (photo included) but I appreciate our friendship and love the fact that no matter how time passes between visits we can pick up right where we left off. ",
    ...
    {
      "from": "Megan",
      "message": "Happy Birthday Renee!  We are getting so old that I’m having a hard time thinking of something funny to say.",
      "memory": "So many good memories.  I remember waking up and seeing you and Dan cleaning up my puke.  You said “It’s okay, we’ve all been there” with a big smile on your face.  Another memorable moment was when we got out the ziplock bags to try and push Jaxx’s butthole back in.  Simpler times, good times..",
      "img": images.megan
    },
    {
      "from": "Aunt Terrie",
    ...
    },
    {
      ...
      "memory": "All of us spending time together with the kids, you digging a hole in the sand so you could lay on your stomach when you were pregnant with Ben, and laughing when Riley tried to say “armoire” are a few of my favorite memories with you  :) ",
      "img": images.em
    },
    {
      "from": "Aunt Sue",
    ...
    },
    {
      ...
      "message": "I’m thankful for your birth. I’m thankful for the smiles you’ve brought the Clarion Crew and you are an inspiration to me in the running world! ",
    ...
    },
    {
      ...
      "memory": "We met as RAs, and I have learned a ton from her over the years. The year we worked together I had just gone through a crappy break up and she gave me a CD called “Therapy, Punk Rock Style” and to this day I enjoy many of those songs when I need to let out some anger. \n\nThat same year I went to her house for thanksgiving (since my plans changed and I hated the idea of going home). Before getting there, she told me that her family lives “through their house and it’s where they store and drop stuff when going from one thing to the next”, so it might not be clean. Again, I live by this idea today with my family and think of where I learned it. ",
      "img": images.mattO
    },
    {
      "from": "Caleb Rice",
      "message": "Happy birthday!!!  Miss yous guys!",
      "memory": "I met Renee when I went to an African tribal acrobat show with Corey and Vanessa at Clarion.  My favorite memories of Renee are of the Halloween parties and running into you guys at Clarks donuts on a random Saturday made my day.  You’ve always been so easy to talk to and I’ve always admired how kind you are everyone",
      "img": images.caleb
    },
    {
    ...
    },
    {
      ...
      "memory": "Hang-outs in the old college apartment were so rad that your ceiling caved in. Also, remember when we went to see Blink-182 and I forgot the tickets? 🎵That sucked, I know.🎵",
      "img": images.corey
    },
    {
      "from": "Mary Kaup",
    ...
    {
      "from": "Alisha ",
      "message": "Happy 40th my dear friend ❤️",
    ...
    },
    {
      ...
      "memory": "My favorite memory is when we roomed together in Hershey and became friends. And her kicking my butt in all the races we ran together 🤣",
      "img": images.ashley
    },
    {
      "from": "Rich Beach",
